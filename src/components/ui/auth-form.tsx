...
const Button: React.FC<ButtonProps> = ({ children, className, ...props }) => (
  <button
    className={`rounded-md bg-gradient px-4 py-2 text-lg text-black
...
const Logo: React.FC = () => (
  <div className="mb-6 flex justify-center">
    <span className="ml-2 text-4xl font-bold text-gradient">Hardik's AI</span>
  </div>
)

const Header: React.FC = () => (
  <div className="mb-6 text-center">
    <h1 className="text-2xl font-semibold text-gradient">Sign in to your account</h1>
